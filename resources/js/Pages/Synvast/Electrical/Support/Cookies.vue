      ...
      <template #page>
        <v-row>
          <v-col cols="9">
            ...
            <v-card>
              <v-card-title>Cookie Policy Agreement</v-card-title>
              <v-card-text>
                <p>Cookies: Explain how your website will use cookies, a small file that tracks a user's activity.</p>
                <h2>Cookies</h2>
			<p>To enrich and perfect your online experience, Brenden Tech uses "Cookies", similar technologies and services provided by others to display personalized content, appropriate advertising and store your preferences on your computer.</p>
			<p>A cookie is a string of information that a website stores on a visitor's computer, and that the visitor's browser provides to the website each time the visitor returns. Brenden Tech uses cookies to help Brenden Tech identify and track visitors, their usage of https://www.eusda.org/, and their website access preferences. Brenden Tech visitors who do not wish to have cookies placed on their computers should set their browsers to refuse cookies before using Brenden Tech's websites, with the drawback that certain features of Brenden Tech's websites may not function properly without the aid of cookies.</p>
			<p>By continuing to navigate our website without changing your cookie settings, you hereby acknowledge and agree to Brenden Tech's use of cookies.</p>
			
						

            <h1>Cookie Policy for Brenden Tech</h1>

<p>This is the Cookie Policy for Brenden Tech, accessible from https://www.eusda.org/</p>
