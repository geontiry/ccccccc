<script>
import VideoCard from '@/Pages/Brenden/EBookshop/VideoCard.vue'
...
export default{
  ...
  setup (props, ctx) {
    const state = reactive({  
      ...
      channel: { url: '/channel', avatar: 'profile.png'}      
    })

    onMounted(() => setTimeout(() => loading = false, 3000))
