<template>
    ...
    >
        <v-avatar class="d-block text-center mx-auto mt-4" size="40"
            ><v-icon color="#704232">fas fa-coffee</v-icon></v-avatar
        >
...
export default {
    data: () => ({
        ...
        items: [
            ...
            { icon: "fas fa-hamburger", text: "POS" },
            { icon: "fas fa-history", text: "Orders" },
            { icon: "fas fa-wallet", text: "Email" },
            { icon: "fas fa-percent", text: "Message" },
