...
<section id="why-us" class="why-us section-bg" data-aos="fade-up">
    <div class="row">
        ...
        <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("src/why-us.png");' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
    </div>
</section>
<section id="skills" class="skills" data-aos="fade-up">
    <div class="row">
        <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
            <img src="src/skills.png" class="img-fluid" alt="">
        </div>
