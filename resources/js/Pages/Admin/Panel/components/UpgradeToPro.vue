<template>
  <v-menu top offset-y content-class="elevation-9" open-on-hover close-delay="750" :close-on-content-click="false" eager transition="slide-y-reverse-transition" left nudge-top="15">
    ...
    >
      <v-img
        max-width="400"
        eager
        src="/storage/assets/images/pro/materio-banner.png"
