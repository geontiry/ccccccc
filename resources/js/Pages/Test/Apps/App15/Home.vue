            ...
            <v-row>
                <v-col cols="12">
                    ...
                    <v-toolbar flat color="transparent" class="mt-5">
                        <v-toolbar-title class="text-h6"
                            >Popular Product</v-toolbar-title
                        >
                        <v-spacer></v-spacer>
                        ...
                        <v-row>
                            ...
                            <v-col cols="12" xs="12" sm="6" md="7">
                                ...
                                <p>
                                    ...
                                    adipisicing elit.<br />
                                    Provident sequi esse tempore maiores quasi
                                    quia non.<br />
                                    Itaque laboriosam dicta nostrum accusantium
                                    assumenda,<br />
                                    vitae ab ut vel tenetur minima natus
                                    commodi!
                                </p>
...
<script>
import Navbar from "@/Pages/Test/Apps/App15/components/Navbar.vue";
import Footer from "@/Pages/Test/Apps/App15/components/Footer.vue";
import Category from "@/Pages/Test/Apps/App15/components/Category.vue";
import Product from "@/Pages/Test/Apps/App15/components/Product.vue";
import Pack from "@/Pages/Test/Apps/App15/components/Pack.vue";
import Client from "@/Pages/Test/Apps/App15/components/Client.vue";
import Partner from "@/Pages/Test/Apps/App15/components/Partner.vue";
