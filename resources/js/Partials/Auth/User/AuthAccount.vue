...
export default { 
  ...
  setup (props, ctx) {
    ...
    const profileitems = ref([
        { title: 'My Profile', href: route('selfcare.profile'), icon: 'mdi-account-circle-outline',},
        { title: 'My Billing', href: route('selfcare.billing'), icon: 'mdi-account-circle-outline',},
        { title: 'My Payment', href: route('selfcare.payment'), icon: 'mdi-account-circle-outline',},
        { title: 'My Orders', href: route('selfcare.orders'), icon: 'mdi-account-circle-outline',},
        { title: 'My History', href: route('selfcare.history'), icon: 'mdi-account-circle-outline',},
        { title: 'My Wallet', href: route('selfcare.wallet'), icon: 'mdi-briefcase-account-outline',},
        { title: 'My Messages', href: route('selfcare.messages'), icon: 'mdi-account-circle-outline',},
        { title: 'My Settings', href: route('selfcare.settings'), icon: 'mdi-account-cog-outline',},
    ])
      ...
      <v-menu offset-y transition="scale-transition" bottom>
            ...
            <v-list dense>
                <v-list-item v-for="(profileitem, index) in profileitems"  :key="index">
                    <v-list-item-title><inertia-link :href="profileitem.href"><v-icon>{{ profileitem.icon }}</v-icon>{{ profileitem.title }}</inertia-link></v-list-item-title>
                </v-list-item>
                <v-divider></v-divider>
                <v-list-item>
