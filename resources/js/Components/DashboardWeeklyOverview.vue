...
export default { 
  ...
  setup (props, ctx) {
    ...
    const chartOptions = {
      ...
      chart: { type: 'bar', toolbar: { show: false, }, offsetX: -15, },
      plotOptions: { 
        bar: { columnWidth: '40%', distributed: true, borderRadius: 8, startingShape: 'rounded', endingShape: 'rounded' }, 
      },
      ...
      yaxis: { 
        show: true, 
        tickAmount: 4, 
        labels: { offsetY: 3, formatter: value => `$${value}` }
      },
      stroke: { width: [2, 2],},
      grid: { strokeDashArray: 12, padding: { right: 0,} },
    }
    ...
    return { 
      chartOptions, chartData, icons: { mdiDotsVertical, mdiTrendingUp, mdiCurrencyUsd,},
    }
  }
} 
</script>
