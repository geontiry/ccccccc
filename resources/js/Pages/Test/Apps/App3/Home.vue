...
import Table from "@/Pages/Test/Apps/App3/Table.vue";
import History from "@/Pages/Test/Apps/App3/History.vue";
import Appointment from "@/Pages/Test/Apps/App3/Appointment.vue";
export default {
    name: "Home",
    data: () => ({
        lists: [
