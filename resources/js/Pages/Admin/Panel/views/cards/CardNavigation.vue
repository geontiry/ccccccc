      ...
      <v-card>
        ...
        <v-tabs-items v-model="tab">
          <v-tab-item v-for="item in items" :key="item" class="mt-2">
            ...
            <v-card-text><v-btn color="primary">Learn More</v-btn></v-card-text>
          </v-tab-item>
        </v-tabs-items>
      </v-card>
    </v-col>
    ...
    <v-col md="6" cols="12">
      <v-card>
        ...
        <v-tabs-items v-model="tab2">
          <v-tab-item v-for="item in items" :key="item" class="text-center mt-2"          >
            <v-card-title class="d-flex justify-center">Navigation Card</v-card-title>
            <v-card-text v-text="text"></v-card-text>
            <v-card-text><v-btn color="primary">Learn More</v-btn></v-card-text>
          </v-tab-item>
        </v-tabs-items>
