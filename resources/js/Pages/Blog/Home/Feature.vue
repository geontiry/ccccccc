  ...
  <div>
    <v-app>
       <v-container class="app">
         <v-card class="my-2">
        <v-img src="https://images.pexels.com/photos/3244513/pexels-photo-3244513.jpeg" gradient="to top, rgba(25,32,72,.7), rgba(25,32,72,.0)" :aspect-ratio="16 / 9" height="500px" dark>
