<script>
//import AppContainer from '@/Pages/Admin/Panel.vue'
...
export default{
  ...
  setup (props, ctx) {
    ...
    return { ...toRefs(state), isCardDetailsVisible, rating, } 
  }
} 
</script>
  ...
  <div>
    <v-row>
      ...
      >
        <v-card>
          <v-img
            src="storage/assets/images/pages/card-basic-influencer.png"
            height="250"
          />
          <v-card-title>
            Influencing The Influencer
      ...
      >
        <v-card>
          <v-img
            ...
            src="storage/assets/images/pages/card-basic-person.png"
            height="250"
          />
          <v-card-text class="position-relative">
            ...
            <v-avatar
              ...
              class="avatar-center"
            >
              <v-img src="storage/assets/images/avatars/1.png"></v-img>
            </v-avatar>
            ...
            <div class="d-flex justify-space-between align-center mt-8">
              ...
              <v-avatar size="40">
                <v-img src="storage/assets/images/avatars/2.png"></v-img>
              </v-avatar>
            </div>
          </v-card-text>
        </v-card>
      ...
      >
        <v-card>
          <v-img src="/storage/assets/images/pages/card-basic-person.png" height="250"></v-img>
          ...
          <v-card-actions class="dense">
            ...
            <v-btn icon @click="isCardDetailsVisible = !isCardDetailsVisible">
              <v-icon>{{ isCardDetailsVisible ? "mdi-chevron-up" : "mdi-chevron-down" }}</v-icon>
            </v-btn>
          </v-card-actions>
          <v-expand-transition>
          ...
          <div class="d-flex justify-space-between flex-wrap flex-md-nowrap flex-column flex-md-row">
            <div class="mx-auto">
              <v-img
                width="220"
                height="100%"
                src="storage/assets/images/pages/card-basic-mobile.png"
              ></v-img>
            </div>
            <v-divider :vertical="$vuetify.breakpoint.mdAndUp"></v-divider>
            <div>
              <v-card-title>Apple iPhone 11 Pro</v-card-title>
              <v-card-text>Apple iPhone 11 Pro smartphone. Announced Sep 2019. Features 5.8″ display Apple A13 Bionic</v-card-text>
              ...
              <v-card-actions class="d-flex justify-space-between dense">
                <v-btn text color="primary" dark><v-icon>mdi-cart-plus</v-icon><span class="ms-2">Add to cart</span></v-btn>
      ...
      <v-col sm="6" cols="12">
        <v-card>
          <div class="d-flex flex-column-reverse flex-md-row">
            <div>
              <v-card-title>Stumptown Roasters</v-card-title>
              <v-card-text class="d-flex align-center flex-wrap body-1">
                <v-rating v-model="rating" color="warning" background-color="warning" dense class="me-3 flex-shrink-0"></v-rating>
                <span class="text-sm">5 Star | 98 reviews</span>
              </v-card-text>
              <v-card-text>Before there was a United States of America, there were coffee houses, because how are you supposed to build.</v-card-text>
              <v-card-actions class="dense">
                <v-btn text color="primary" dark>Location</v-btn>
                <v-btn dark text color="primary">Reviews</v-btn>
              </v-card-actions>
            </div>
            <div class="pa-4">
              <v-img src="/storage/assets/images/pages/card-basic-clock.jpg" :class="$vuetify.breakpoint.mdAndUp ? 'rounded-lg':'rounded-0'" height="100%" :max-width="$vuetify.breakpoint.mdAndUp ? '220':'100%'"></v-img>
            </div>
          </div>
        </v-card>
      </v-col>
      ...
      <v-col lg="4" sm="6" cols="12" class="align-self-start">
        <v-card>
          <v-img src="storage/assets/images/pages/card-basic-brown-watch.jpg"></v-img>
          <v-card-title>Apple Watch</v-card-title>
          <v-card-text><p class="text--primary text-base">$249.40</p>3.1GHz 6-core 10th-generation Intel Core i5 processor, Turbo Boost up to 4.5GHz</v-card-text>
          <v-card-actions class="primary pa-0">
            <v-btn color="primary" block dark large>Add to cart</v-btn>
          </v-card-actions>
        </v-card>
      </v-col>
      <!-- Lifetime Membership -->
            ...
            >
              ...
              <v-card-actions class="d-flex justify-center">
                ...
                <div class="ms-auto ps-4">
                  <p class="d-flex align-center mb-6">
                    <v-icon color="primary">mdi-hexagram-outline</v-icon>
      ...
      >
        <v-card color="text-center">
          <v-card-text class="d-flex flex-column justify-center align-center">
            <v-avatar color="primary" class="mt-10" icon size="50"><v-icon size="2rem" color="white">mdi-help-circle-outline</v-icon></v-avatar>
          ...
          <v-card-text><v-btn color="primary" class="mt-4">Contact Now</v-btn></v-card-text>
        </v-card>
      </v-col>
    </v-row>
  </div>
...
@import '@/materio/sass/preset/mixins.scss';
