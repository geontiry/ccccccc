<script>
import SideBar from "@/Layouts/Portal/SideBar.vue"
...
export default { 
  ...
  setup (props, ctx) {
    const select = ref({ state: "EN" })
    const items = ref(["EN", "ES", "DZ"])
    const text = ref("weekly")
    const width = ref(2)
    const radius = ref(10)
    const padding = ref(8)
    ...
    <v-app id="inspire">
        ...
        <v-container>
            <v-app-bar color="rgba(0,0,0,0)" flat>
                ...
                ></v-select>
                <span text color="#878A94">AAE Ideapro</span>
            ...
            <v-row>
                <v-col cols="12" sm="8">
                    ...
                    >
                        <v-row>
                            <v-col cols="12" sm="8">
                                <v-list-item three-line>
                                    <v-list-item-content>
                                        ...
                                        <v-list-item-subtitle
                                            >Wecome back AAE IdeaPro. We are
                                            glad here.<br />
                                            Inspire the best work in
                                            people.enabling them to acheive
                                        </v-list-item-subtitle>
                                        <v-list-item-subtitle>
                                            thier goals.
                                        </v-list-item-subtitle>
                                ...
                                <v-card-actions>
                                    <v-btn class="px-3" color="blak" dark>
                                        View Details
                                    </v-btn>
                                </v-card-actions>
                            </v-col>
                            <v-col cols="12" sm="4">
                                <v-img src="1.png" class="mt-n16"></v-img>
                            </v-col>
                        </v-row>
                    </v-card>
                    <v-toolbar flat color="rgba(0,0,0,0)" dense class="mt-n1">
                        <v-toolbar-title>Trending Blogs</v-toolbar-title>
                        <v-spacer></v-spacer>
                        <span class="grey--text">View All</span>
                    </v-toolbar>
                    <v-row class="mt-n5">
                        <v-col cols="12" sm="4">
                            <v-card
                            ...
                            >
                                ...
                                <v-card-text class="">
                                    A prototype is an early <br />sample, model
                                    or realease of a productbuilt to test a..
                                </v-card-text>
                        ...
                        <v-col cols="12" sm="4">
                            ...
                            >
                                ...
                                <v-card-text class="">
                                    In essence, typography is the artof
                                    arranging letters and text in away that..
                                </v-card-text>
                        ...
                        <v-col cols="12" sm="4">
                            ...
                            >
                                ...
                                <v-card-text class="">
                                    The best way to use a scheme like this is to
                                    use one color as the primary..
                                </v-card-text>
                    ...
                    <v-card
                        class="mx-4 rounded-xl pa-6 mt-2"
                        color="grey lighten-3"
                        flat
                    >
                        <v-toolbar
                ...
                <v-col cols="12" sm="4">
                    ...
                    >
                        ...
                        <v-app-bar color="rgba(0,0,0,0)" tile class="mt-3">
                            ...
                            <strong class="subtitle black--text ml-2">
                                Claps This Week
                                <span class="caption"><br />1.5k</span>
                            </strong>
                            <v-spacer></v-spacer>
                            <v-icon color="grey" class="ml-2"
                                >fas fa-chevron-circle-right</v-icon
                        ...
                        <v-app-bar color="rgba(0,0,0,0)" tile class="mt-3">
                            ...
                            <strong class="subtitle black--text ml-2">
                                ...
                                <span class="caption"><br />972</span>
                            </strong>
                            <v-spacer></v-spacer>
                            <v-icon color="grey" class="ml-2"
                                >fas fa-chevron-circle-right</v-icon
                        ...
                        <v-card
                            color="white"
                            class="rounded-xl mx-4 pa-10"
                            flat
                        >
                            <div class="text-center">
                                <span
                                    >Buy <strong>Pro Account</strong> to Explore
                                    <br />Premium Features</span
                                >
                                <v-btn class="mt-5" dark color="black"
                                    >Purchase Now</v-btn
                                >
                            </div>
                        </v-card>
