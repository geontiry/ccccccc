...
export default {
  ...
  data: function () {
    return {
      deposit: [
      {
        img: '/storage/dash/logos/gumroad.png',
        title: 'Gumroad Account',
        subtitle: 'Sell UI Kit',
        amount: '+$4,650',
      },
      {
        img: '/storage/dash/logos/master.png',
        title: 'Mastercard',
        subtitle: 'Wallet deposit',
        amount: '+$92,705',
      },
      {
        img: '/storage/dash/logos/stripe-account.png',
        title: 'Stripe Account',
        subtitle: 'iOS Application',
        amount: '+$957',
      },
      {
        img: '/storage/dash/logos/american-bank.png',
        title: 'American Bank',
        subtitle: 'Bank Transfer',
        amount: '+$6,837',
      },
      {
        img: '/storage/dash/logos/bank-account.png',
        title: 'Bank Account',
        subtitle: 'Wallet deposit',
        amount: '+$446',
      },
    ...
    withdraw: [
      {
        img: '/storage/dash/logos/google.png',
        title: 'Google Adsense',
        subtitle: 'Paypal deposit',
        amount: '-$145',
      },
      {
        img: '/storage/dash/logos/github.png',
        title: 'Github Enterprise',
        subtitle: 'Security & compliance',
        amount: '-$1870',
      },
      {
        img: '/storage/dash/logos/slack.png',
        title: 'Upgrade Slack Plan',
        subtitle: 'Debit card deposit',
        amount: '-$450',
      },
      {
        img: '/storage/dash/logos/digital-ocean-logo.png',
        title: 'Digital Ocean',
        subtitle: 'Cloud Hosting',
        amount: '-$540',
      },
      {
        img: '/storage/dash/logos/amazon-web-services-logo.png',
        title: 'Bank Account',
